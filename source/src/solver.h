...
private:
	...
	bool _topo_sort(ckt_n::nodelist_t* order, ckt_n::node_t* start, ckt_n::node_t* end);
	void _cycle_search(ckt_n::node_t* r, ckt_n::nodelist_t* cycle_list);
	void _add_lit(std::vector<sat_n::vec_lit_t*>* clauses, std::vector<sat_n::vec_lit_t*>* in, int index, bool value);
	void _add_key_constraint(ckt_n::nodelist_t* order);
	void _add_lits(std::vector<sat_n::vec_lit_t*>* clauses, std::vector<sat_n::vec_lit_t*>* in, sat_n::vec_lit_t* c);
	void _append_lit_vec(std::vector<sat_n::vec_lit_t*>* dest, std::vector<sat_n::vec_lit_t*>* origin);
